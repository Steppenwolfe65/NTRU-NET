...
namespace NTRU.Encode
{
    ...
    public class ArrayEncoder
    {
        ...
        public static int[] DecodeModQ(MemoryStream InputStream, int N, int Q)
        {
        ...
        public static byte[] ReadFullLength(MemoryStream InputStream, int Length)
        {
