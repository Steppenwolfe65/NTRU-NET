...
namespace NTRU.Arithmetic
{
    ...
    public sealed class SchonhageStrassen
    {
        ...
        /// 
        /// <remarks>
        /// Both numbers are given as <c>int</c> arrays and must be <b>positive</b> numbers (meaning they are interpreted as unsigned).
        ...
        /// <summary>
        /// Multiplies two <b>positive</b> numbers represented as int arrays, i.e. in base <c>2^32</c>.
        ...
        /// <summary>
        /// Multiplies two <b>positive</b> numbers (meaning they are interpreted as unsigned) modulo Fn where Fn=2^2^n+1, and returns the result in a new array.
        /// </summary>
        /// 
        /// <param name="A">A number in base 2^32 starting with the lowest digit; the length must be a power of 2</param>
        /// <param name="B">A number in base 2^32 starting with the lowest digit; the length must be a power of 2</param>
        ...
        private static int[][] SplitBits(int[] A, int BitLength)
        {
            ...
            int[][] b = ArrayExtensions.CreateJagged<int[][]>(numPieces, pieceLength);
        ...
        {
            int[][] ai = ArrayExtensions.CreateJagged<int[][]>(NumPieces, TargetPieceSize);
